 ...
 *
 * Modifications by Binary Bit LAN
 * Changes made to pass jslint test
 * Format changes made to pass our requirements
 * Added function to Add or Edit Chords
...
var jtab = 
{
    ...
    Chords : 
    {
        /* chord data - currently explicit representation for 6 string guitar, standard tuning only, and each chord is an array of alternate positions
         *   0   : 1st (open) position
         *   1   : 1st barre position, generally at 12/13/14th fret
         *         - minimum, only required for CAGED chords where open strings are used in the 1st (open) position since the main purpose of this is to provide barre fingering positions for CAGED-based chords
        ...
        "C7"    : [ [ 0, [-1 ],  [3,3],  [2,2],  [3,4],  [1,1],  [0  ] ], [ 12, [-1,-1],  [15,3],  [14,2],  [15,4],  [13,1],  [12,1 ] ] ], /* Missing last pair; was [12, ] */
        ...
        "G7b9"  : [ [ 0, [3,4],  [2,3],  [0  ],  [1,1],  [0  ],  [1,2] ], [ 12, [15,4],  [14,3],  [12,1],  [13,2],  [12,1],  [13,2] ] ], /* was [13, ] */
        ...
        "A9"    : [ [ 0, [-1 ],  [0  ],  [2,1],  [4,4],  [2,2],  [3,3] ], [ 12, [-1],    [12,1 ],  [14,1],  [16,4],  [14,2],  [15,3] ] ], /* was [12, ] */
        "Am9"   : [ [ 0, [-1 ],  [0  ],  [1,1],  [1,1],  [1,1],  [3,4] ], [ 12, [-1],    [12,1 ],  [13,2],  [13,2],  [13,2],  [15,4] ] ],
        "Amaj9" : [ [ 0, [-1 ],  [0  ],  [2,1],  [4,3],  [2,1],  [4,4] ], [ 12, [-1],    [12,1 ],  [14,1],  [16,3],  [14,1],  [16,4] ] ], /* was [12, ]*/
        ...
        "Aaug"  : [ [ 0, [-1 ],  [0  ],  [3,4],  [2,2],  [2,3],  [1,1] ], [ 12, [-1],    [12,1 ],  [15,4],  [14,2],  [14,3],  [13,1] ] ], /* was [12,] */

        "B"    : [ [ 0, [-1 ],  [1,1],  [3,3],  [3,3],  [3,3],  [1,1] ], [  ] ],
        "Bm"   : [ [ 0, [-1 ],  [1,1],  [3,3],  [3,4],  [2,2],  [1,1] ], [  ] ],
        "B6"   : [ [ 0, [-1 ],  [1,1],  [3,3],  [3,3],  [3,3],  [3,3] ], [  ] ],
        "Bm6"  : [ [ 0, [-1 ],  [1,1],  [3,3],  [0  ],  [2,2],  [-1 ] ], [  ] ],
        "B69"  : [ [ 0, [-1 ],  [1,1],  [0  ],  [0  ],  [1,2],  [1,3] ], [  ] ],
        "B7"   : [ [ 0, [-1 ],  [1,1],  [3,3],  [1,1],  [4,4],  [1,1] ], [  ] ],
        "Bm7"  : [ [ 0, [-1 ],  [1,1],  [3,3],  [1,1],  [2,2],  [1,1] ], [  ] ],
        "Bmaj7": [ [ 0, [-1 ],  [1,1],  [3,3],  [2,2],  [3,4],  [1,1] ], [  ] ],
        "B7b5" : [ [ 4, [6,2],  [-1 ],  [6,3],  [7,4],  [5,1],  [-1 ] ], [  ] ],
        "B7#5" : [ [ 5, [6,1],  [-1 ],  [6,2],  [7,3],  [7,4],  [-1 ] ], [  ] ],
        "Bm7b5": [ [ 0, [-1 ],  [1,1],  [-1 ],  [1,2],  [2,3],  [-1 ] ], [  ] ],
        "B7b9" : [ [ 6, [-1 ],  [-1 ],  [8,2],  [7,1],  [9,4],  [7,1] ], [  ] ],
        "B9"   : [ [ 0, [1,1],  [1,2],  [0  ],  [1,3],  [1,3],  [1,3] ], [  ] ],
        "Bm9"  : [ [ 5, [-1 ],  [-1 ],  [-1 ],  [6,1],  [6,1],  [8,4] ], [  ] ],
        "Bmaj9": [ [ 0, [-1 ],  [1,1],  [0  ],  [2,4],  [1,2],  [1,3] ], [  ] ],
        "Badd9": [ [ 0, [1,1],  [1,1],  [0  ],  [3,4],  [1,1],  [1,1] ], [  ] ],
        "B13"  : [ [ 0, [-1 ],  [1,1],  [0  ],  [1,2],  [3,4],  [3,4] ], [  ] ],
        "Bsus2": [ [ 0, [-1 ],  [1,1],  [3,3],  [3,4],  [1,1],  [1,1] ], [  ] ],
        "Bsus4": [ [ 0, [-1 ],  [1,1],  [3,2],  [3,3],  [4,4],  [1,1] ], [  ] ],
        "Bdim" : [ [ 0, [-1 ],  [1,1],  [2,2],  [3,4],  [2,3],  [-1 ] ], [  ] ],
        "Bdim7": [ [ 0, [-1 ],  [-1 ],  [2,1],  [3,3],  [2,2],  [3,4] ], [  ] ],
        "Baug" : [ [ 0, [-1 ],  [1,1],  [4,4],  [3,2],  [3,3],  [2,1] ], [  ] ],
    ...
    WesternScale: 
    {
        ...
        BaseIntervals: ['C', 'C#', 'D', 'Eb', 'E', 'F', 'F#', 'G', 'G#', 'A', 'B', 'H']
    },
    ChordList : function() 
    {
        var list = [], key;
        for (key in jtab.Chords) 
        {
            if (jtab.Chords.hasOwnProperty(key)) 
            {
                list.push(key);
            }
        }
...
{
    var max = this[0].length, i, len = this.length;
    for (i = 1; i < len; (i += 1))
    {     
 ...
 */
var JtabChord = $.klass( /* Class.create( */
{
    initialize: function(token) 
    {
        var baseNoteInfo, parts;
        ...
        baseNoteInfo = this.baseNotes[this.rootNote];
        if (baseNoteInfo) 
        {
    ...
    setChordArray: function(chordName) 
    { 
        ...
        this.isValid = true;
        modelRef = this.baseChords[chordName][0];
        this.chordArray[0] = modelRef[0];
        for (i = 1; i < modelRef.length; (i += 1)) 
        {
    ...
    setCagedChordArray: function() 
    {
        ...
        var fret_widths, starting_fret, i, index, modelChord, caged_index = "CAGED".indexOf(this.cagedBaseShape) + 1; // get 1-based index
        fret_widths = [3,2,3,2,2];
        starting_fret = this.cagedBaseFret;
        for (i = 1; i < this.cagedPos; (i += 1)) 
        {
          index = (caged_index - 1) % 5;
          caged_index  = ( caged_index >= 5) ? 1 : caged_index + 1;
          starting_fret += fret_widths[index];
        }
        modelChord =  "CAGED".charAt( caged_index - 1 ) + this.rootExt;
        this.setChordArray(modelChord);
        this.shiftChordArray(starting_fret,modelChord);
    },
    shiftChordArray: function(atFret,modelChord) 
    { 
        /* shift chord to new fret position */
        var initFret = this.chordArray[0], use_caged_fingering, i, fret, finger;
        if (atFret !== initFret) 
        {
            use_caged_fingering = ( (this.isCaged) && (this.cagedPos > 0) && ( ( this.baseChords[modelChord][1][0] !== undefined ) )  );
            this.chordArray[0] = atFret - 1;
            for (i = 1; i < this.chordArray.length; (i += 1)) 
            {
                fret = (this.chordArray[i][0] >= 0 ) ? this.chordArray[i][0] + atFret - initFret : this.chordArray[i][0];
                finger = (use_caged_fingering) ? this.baseChords[modelChord][1][i][1] : this.chordArray[i][1];
...
{
    // h ticks
    this.path({stroke: this.color, "stroke-width":0.2 }).relatively().moveTo(this.current_offset, 0).lineTo(0, 4);
    this.path({stroke: this.color, "stroke-width":0.2 }).relatively().moveTo(this.current_offset + this.margin_left, 0).lineTo(0, 2);
    this.path({stroke: this.color, "stroke-width":0.2 }).relatively().moveTo(this.current_offset + width - this.margin_right, 0).lineTo(0, 2);
    // v ticks
    if (this.tabtype === 3) 
    {
        this.path({stroke: this.color, "stroke-width":0.2 }).relatively().moveTo(this.current_offset, this.tab_margin_top).lineTo(2, 0);
    } 
    else 
    {
        this.path({stroke: this.color, "stroke-width":0.2 }).relatively().moveTo(this.current_offset, this.margin_top).lineTo(2, 0);
    }
};
/* ************************************************************************* */
/*
...
{
    var fret_left = this.current_offset + this.margin_left, fret_labels = [ '', '', '', 'III', '', 'V', '', 'VII', '', 'IX', '', '', 'XII', '', '', 'XV', '', 'XVII', '', 'XIX', '', 'XXI', '' ], i, pos;
    this.text( /* chord name */ fret_left + 2.5 * this.string_spacing, this.margin_top - 20, chord_name).attr({stroke: this.tab_text_color, "font-size":"20px"});
    if ( position === 0 ) 
    { 
        // nut
        this.path({stroke: this.color, "stroke-width":3 }).relatively().moveTo(fret_left, this.margin_top).lineTo(this.string_spacing * (this.strings_drawn - 1), 0);
    } 
    else 
    {
        this.path({stroke: this.color, "stroke-width":1 }).relatively().moveTo(fret_left, this.margin_top).lineTo(this.string_spacing * (this.strings_drawn - 1), 0);
    }
    for (i = 0; i <= this.frets_drawn; (i += 1) ) 
    { 
        // frets
        this.path({stroke: this.color}).relatively().moveTo(fret_left, this.margin_top + (i * this.fret_spacing) ).lineTo(this.string_spacing * (this.strings_drawn - 1), 0 );
        pos = (fret_labels[ position + i ] === undefined ) ? '' : fret_labels[position + i];
        if (pos.length > 0) 
        { 
            // draw fret position
            this.text(fret_left + this.fret_width + this.string_spacing * 1.0, this.margin_top + ( ( i - 0.5 ) * this.fret_spacing), pos).attr({stroke: this.tab_text_color, "font-size":"12px"});
        }
    }
    for (i = 0; i < this.strings_drawn; (i += 1) ) 
    { 
        // strings
        this.path({stroke: this.color}).relatively().moveTo(fret_left + (i * this.string_spacing), this.margin_top).lineTo(0, this.fret_spacing * (this.frets_drawn + 0.5) );
    }
...
Raphael.fn.stroke = function() 
{
    ...
    if (this.has_tab) 
    {
        width = this.tab_char_width * 3;
        // extend tab
        this.tab_extend(width);
        //  stroke
        this.path({stroke: this.tab_text_color, "stroke-width":4 }).relatively().moveTo(this.current_offset + this.tab_char_width, this.tab_top  + (3.5 * this.tab_spacing) ).lineTo(this.tab_char_width, - 2 * this.tab_spacing );
        this.increment_offset(width);    
    } 
    else if (this.has_chord) 
    {
        dx = this.string_spacing;
        dy = 2 * this.fret_spacing;     
        this.path({stroke: this.tab_text_color, "stroke-width":4 }).relatively().moveTo(this.current_offset + this.margin_left, this.margin_top + this.fret_spacing + dy ).lineTo(dx, -dy );
...
Raphael.fn.bar = function() 
{
    ...
    if (this.has_tab) 
    {
        width = this.tab_char_width * 2;
        // extend tab
        this.tab_extend(width);
        this.path({stroke: this.color, "stroke-width":1 }).relatively().moveTo( /*  bar */ this.current_offset + this.tab_char_width, this.tab_top ).lineTo( 0, this.tab_height );
        this.increment_offset(width);    

    } 
    else if (this.has_chord) 
    { 
        fret_left = this.current_offset + this.margin_left;
        this.path({stroke: this.color, "stroke-width":1 }).relatively().moveTo(this.current_offset + this.margin_left, this.margin_top  ).lineTo(0, this.fret_height );
...
Raphael.fn.doublebar = function() 
{
    ...
    if (this.has_tab) 
    {
        width = this.tab_char_width + 8;
        // extend tab
        this.tab_extend(width);
        //  bar
        this.path({stroke: this.color, "stroke-width":1 }).relatively().moveTo(this.current_offset + this.tab_char_width, this.tab_top ).lineTo(0, this.tab_height );
        this.path({stroke: this.color, "stroke-width":4 }).relatively().moveTo(this.current_offset + this.tab_char_width + 6, this.tab_top ).lineTo(0, this.tab_height );
        this.increment_offset(width);    

    } 
    else if (this.has_chord) 
    { 
        left = this.current_offset + this.margin_left;
        this.path({stroke: this.color, "stroke-width":1 }).relatively().moveTo(left, this.margin_top  ).lineTo(0, this.fret_height );
        this.path({stroke: this.color, "stroke-width":4 }).relatively().moveTo(left + 6, this.margin_top  ).lineTo(0, this.fret_height );
...
Raphael.fn.chord_note = function(position, string_number, note) 
{
    ...
    var fret_number = note[0], fret_left = this.current_offset + this.margin_left, fret_dy;
    if (fret_number < 0 ) 
    {
        // muted/not played
    ...
    {
        fret_dy = (fret_number - position - 0.5) * this.fret_spacing;
        // var circle = 
        this.circle(fret_left + (string_number - 1) * this.string_spacing, this.margin_top + fret_dy, this.note_radius).attr({stroke: this.color, fill: this.color});
        if ( (note[1] !== undefined) ) 
        {
...
Raphael.fn.draw_tab_note = function(string_number, token, left_offset) 
{
    ...
    this.text(this.current_offset + left_offset, this.tab_top + this.tab_spacing * (string_number - 1), token).attr({stroke: this.color, "font-size":"16px"});
};
/* ************************************************************************* */
/*
...
{
    if (this.has_tab === false) { return; }
    var parts, part, width = 2, i, myMaxChars, fullchord_notes, string_number;
    if ( token.match( /\$/ ) !== null ) 
    { 
        ...
        { 
            ...
            {
                part = parts[i]; 
                string_number = this.get_string_number(part);
    ...
    {
        fullchord_notes = this.get_fullchord_notes(token);
        if ( fullchord_notes ) 
        {
            myMaxChars = fullchord_notes.max_chars(); 
            width = this.tab_char_width * (myMaxChars + 2);
            this.tab_extend( width );
            for (i = 0; i < fullchord_notes.length; (i += 1)) 
            {
...
{
    var c = new JtabChord(token), chord, i;
    if ( c.isValid ) 
    { 
        // draw chord
        chord = c.chordArray;
        this.chord_fretboard(chord[0], c.fullChordName );
        for ( i = 1; i < chord.length; (i += 1)) 
        {  
...
{
    var tabtype = 0, gotChord = ( notation.match( /[^\$][A-G]|^[A-G]/ ) !== null ), gotTab;
    gotTab = ( ( notation.match( /\$/ ) !== null ) || ( notation.match( /[0-9|Xx|\.]{6,}/ ) !== null ) );
...
{
    var tabtype = jtab.characterize( notation ), tokens, canvas_holder, canvas, i;
    if (tabtype === 0 ) { return; }
    // add the Raphael canvas in its own DIV. this gets around an IE6 issue with not removing previous renderings
    canvas_holder = new Element('div').setStyle({height: Raphael.fn.total_height});
    $(element).update(canvas_holder);
    jtab.setPalette(element);
    canvas = new Raphael(canvas_holder, 80, Raphael.fn.total_height );
    canvas.tab_start();
    tokens = notation.split(/\s/);
